...
Para usuarios que no son expertos en el uso de Metasploit, se recomienda el uso de la interfaz gráfica del programa, se puede descargar desde el siguiente link \url{https://www.rapid7.com/products/metasploit/download/}. La instalación es muy simple en Linux, basta con descargarse el programa, convertirlo en ejecutable con el comando \emph{\$chmod 777 metasploit-latest-linux-x64-installer.run} y ejecutar el fichero \emph{.run}. Se abrirá un instalador gráfico intuitivo.
